  ...
  return (
    <Card className="w-full max-w-[400px]">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <Label htmlFor="detailsButtonText">Details Button Text</Label>
          <Input
            id="detailsButtonText"
            value={details.detailsButtonText}
            onChange={handleChange("detailsButtonText")}
          />
        </div>

        <div className="space-y-2">
          <Label htmlFor="selectButtonText">Select Button Text</Label>
          <Input
            id="selectButtonText"
            value={details.selectButtonText}
            onChange={handleChange("selectButtonText")}
          />
        </div>
      </CardContent>
    </Card>
